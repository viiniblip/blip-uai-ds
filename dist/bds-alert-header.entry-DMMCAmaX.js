...
var AlertHeader = function() {
  ...
  e.prototype.render = function() {
    var e2;
    return h("div", { key: "d43bde5580a3be573f250fc221e2907db1ea14f5", class: (e2 = { alert__header: true }, e2["alert__header--".concat(this.variant)] = true, e2) }, this.icon && h("bds-icon", { key: "0f8d5cc6a6700628fb6cc19d4f1c74083e7e726d", class: "color-icon", theme: "outline", size: "x-large", name: this.icon }), h("bds-typo", { key: "03f676ffda6d3ebc5733ec493afb4fae604ad8bd", variant: "fs-16", bold: "bold" }, h("slot", { key: "c8671c9d3b29368660de48a376a25365b5028b50" })));
  };
  return e;
}();
AlertHeader.style = alertHeaderCss;
export {
  AlertHeader as bds_alert_header
};
//# sourceMappingURL=bds-alert-header.entry-DMMCAmaX.js.map
