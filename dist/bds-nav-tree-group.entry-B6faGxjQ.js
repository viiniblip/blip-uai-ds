...
var __generator = function(e, t) {
  ...
  function c(s2) {
    ...
    while (i && (i = 0, s2[0] && (r = 0)), r) try {
      if (o = 1, n && (a = s2[0] & 2 ? n["return"] : s2[0] ? n["throw"] || ((a = n["return"]) && a.call(n), 0) : n.next) && !(a = a.call(n, s2[1])).done) return a;
      ...
      switch (s2[0]) {
        ...
        case 7:
          ...
          continue;
        default:
          if (!(a = r.trys, a = a.length > 0 && a[a.length - 1]) && (s2[0] === 6 || s2[0] === 2)) {
            r = 0;
            continue;
          }
...
var NavTreeGroup = function() {
  ...
  e.prototype.componentWillRender = function() {
    ...
    for (var e2 = 0; e2 < this.itemsElement.length; e2++) {
      this.itemsElement[e2].reciveNumber(e2);
    }
  };
  e.prototype.closeAll = function(e2) {
    return __awaiter(this, void 0, void 0, function() {
      var t;
      return __generator(this, function(r) {
        this.bdsNavTreeGroupCloseAll.emit();
        for (t = 0; t < this.itemsElement.length; t++) {
          if (this.collapse != "multiple") {
            if (e2 != t) this.itemsElement[t].close();
          } else {
            this.itemsElement[t].close();
          }
        }
        return [2];
      });
  ...
  e.prototype.openAll = function(e2) {
    return __awaiter(this, void 0, void 0, function() {
      var t;
      return __generator(this, function(r) {
        ...
        for (t = 0; t < this.itemsElement.length; t++) {
          if (this.collapse != "multiple") {
            if (e2 != t) this.itemsElement[t].open();
          } else {
            this.itemsElement[t].open();
          }
        }
        return [2];
      });
...
export {
  NavTreeGroup as bds_nav_tree_group
};
//# sourceMappingURL=bds-nav-tree-group.entry-B6faGxjQ.js.map
