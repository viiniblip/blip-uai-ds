...
var Radio = function() {
  function e(e2) {
    ...
    this.onClick = function(e3) {
      i.checked = true;
      i.bdsClickChange.emit({ checked: i.checked });
      e3.stopPropagation();
    };
  ...
  e.prototype.checkedChanged = function(e2) {
    this.bdsChange.emit({ checked: e2 });
  };
  ...
  e.prototype.connectedCallback = function() {
    this.radioId = this.refer || "bds-radio-".concat(radioButtonIds++);
  };
  e.prototype.handleClickKey = function(e2) {
    if ((e2.key === "Enter" || e2.key === " ") && !this.disabled) {
      this.onClick(e2);
      e2.preventDefault();
...
var Switch = function() {
  ...
  e.prototype.connectedCallback = function() {
    this.switchId = this.refer || "bds-switch-".concat(switchIds++);
  };
  e.prototype.checkedChanged = function(e2) {
    this.bdsChange.emit({ checked: e2 });
  };
  ...
  e.prototype.getSizeClass = function() {
    return "switch switch--size-".concat(this.size, " ");
  };
  e.prototype.getSizeSliderClass = function() {
    return "slider slider--size-".concat(this.size, " round ");
  };
  e.prototype.render = function() {
    var e2, i;
    var t = this;
    var r = this.getSizeClass();
    var o = this.getSizeSliderClass();
    var a = this.getStyleState();
    return h("label", { key: "95d3b92232abd0273a9ae86320d4a2a41f09cdaa", class: (e2 = {}, e2[r] = true, e2) }, h("div", { key: "92cf268fc85154d8bd1975687ae1865fb70278d6", tabindex: "0", onKeyDown: function(e3) {
      return t.handleClick(e3);
    }, class: "focus" }), h("input", { key: "1374eac16eccccd6801dfe3345e3b75677d025fa", type: "checkbox", ref: this.refNativeInput, id: this.switchId, name: this.name, onClick: this.onClick, checked: this.checked, disabled: this.disabled, "data-test": this.dataTest }), h("span", { key: "24b47125aecef86886ece5536c1e639bf8665c03", class: (i = {}, i[o] = true, i[a] = true, i) }));
  };
  Object.defineProperty(e, "watchers", { get: function() {
    return { checked: ["checkedChanged"] };
  }, enumerable: false, configurable: true });
...
export {
  Radio as bds_radio,
  Switch as bds_switch
};
//# sourceMappingURL=bds-radio_2.entry-BBplTw4s.js.map
