...
var __awaiter = function(t, o, i, a) {
  function n(t2) {
    return t2 instanceof i ? t2 : new i(function(o2) {
      o2(t2);
    });
  }
  return new (i || (i = Promise))(function(i2, s) {
    function e(t2) {
      try {
        c(a.next(t2));
      } catch (t3) {
    ...
    function c(t2) {
      t2.done ? i2(t2.value) : n(t2.value).then(e, r);
    }
...
var __generator = function(t, o) {
  ...
  function c(r2) {
    ...
    while (e && (e = 0, r2[0] && (i = 0)), i) try {
      if (a = 1, n && (s = r2[0] & 2 ? n["return"] : r2[0] ? n["throw"] || ((s = n["return"]) && s.call(n), 0) : n.next) && !(s = s.call(n, r2[1])).done) return s;
      if (n = 0, s) r2 = [r2[0] & 2, s.value];
      switch (r2[0]) {
        case 0:
        case 1:
          s = r2;
        ...
        case 7:
          ...
          continue;
        default:
          if (!(s = i.trys, s = s.length > 0 && s[s.length - 1]) && (r2[0] === 6 || r2[0] === 2)) {
            i = 0;
            continue;
          }
          if (r2[0] === 3 && (!s || r2[1] > s[0] && r2[1] < s[3])) {
            i.label = r2[1];
            break;
          }
          if (r2[0] === 6 && i.label < s[1]) {
            i.label = s[1];
            s = r2;
            break;
          }
...
var BdsToast = function() {
  function t(t2) {
    ...
    this._buttonClickHandler = function() {
      if (o.buttonAction === "close") o.close();
      else {
        o.toastButtonClick.emit(o.el);
        o.close();
      }
    };
    this.mapIconName = { system: "bell", error: "error", success: "like", warning: "attention", undo: "undo", redo: "redo", notification: "notification" };
  }
  t.prototype._keyPressHandler = function(t2) {
    if (t2.key === "Enter" || t2.key === " ") {
      t2.preventDefault();
  ...
  t.prototype.create = function(t2) {
    return __awaiter(this, arguments, void 0, function(t3) {
      var o;
      var i = this;
      var a = t3.actionType, n = t3.buttonAction, s = t3.buttonText, e = t3.icon, r = t3.toastText, c = t3.toastTitle, h2 = t3.variant, d = t3.duration;
      return __generator(this, function(t4) {
        o = document.querySelector("bds-toast-container.".concat(h2 === "notification" ? "top-right" : "bottom-left"));
        if (o) {
          o.appendChild(this.el);
          o.classList.add(h2 === "notification" ? "top-right" : "bottom-left");
        } else {
          o = document.createElement("bds-toast-container");
          o.classList.add(h2 === "notification" ? "top-right" : "bottom-left");
          document.body.appendChild(o);
          o.appendChild(this.el);
        }
        this.el.actionType = a || "button";
        this.el.buttonAction = n || "close";
        this.el.buttonText = s;
        this.el.toastText = r;
        this.el.toastTitle = c;
        this.el.variant = h2 || "system";
        this.el.duration = d * 1e3 || 0;
        this.el.position = h2 === "notification" ? "top-right" : "bottom-left";
        this.el.icon = e !== null && e !== void 0 ? e : this.mapIconName[this.variant];
        this.el.show = true;
  ...
  t.prototype.render = function() {
    var t2, o;
    var i = this;
    return h("div", { key: "2196f1a7a0ee9ca2aa87095acb3c5da4746d6c7d", class: (t2 = { toast: true }, t2["toast--".concat(this.variant)] = true, t2["toast--action--".concat(this.actionType)] = true, t2["show show--".concat(this.position)] = this.show, t2.hide = this.hide, t2) }, this.variant === "notification" && h("bds-icon", { key: "f6ac304c504bbcc6d4a0969795cb2c589e870633", class: "toast__ballon", theme: "solid", name: "blip-chat", size: "brand" }), this.icon && h("bds-icon", { key: "f20cf21397152dfb9a079e988eeb9d6c7d003d1c", class: "toast__icon", theme: "outline", size: "medium", name: this.icon }), h("div", { key: "40efb04f0f380908b991d45bd983b92d664e78ea", class: "toast__content" }, this.toastTitle && h("bds-typo", { key: "3a77a0fb420f685040851db899bcc39b31a935d7", variant: "fs-14", bold: "bold" }, this.toastTitle), this.toastText && h("bds-typo", { key: "afb241f37594380cdaabb67b434b5636c3849e7f", variant: "fs-14", innerHTML: this.toastText })), h("div", { key: "615535d9c4e115d31105e648f4b509e27e52142a", class: (o = { toast__action: true }, o["toast__action__".concat(this.actionType)] = true, o) }, this.actionType === "button" ? h("bds-button", { onKeyDown: this._keyPressHandler.bind(this), tabindex: "0", onClick: function() {
      return i._buttonClickHandler();
    }, variant: "secondary", size: "standard", dataTest: this.dtButtonAction }, this.buttonText) : h("bds-button-icon", { onClick: function() {
      return i._buttonClickHandler();
...
export {
  BdsToast as bds_toast
};
//# sourceMappingURL=bds-toast.entry-Bf3OMZ9W.js.map
