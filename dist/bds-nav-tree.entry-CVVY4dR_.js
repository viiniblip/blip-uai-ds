...
var NavTree = function() {
  ...
  e.prototype.reciveNumber = function(e2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(t) {
        this.numberElement = e2;
        return [2];
      });
    });
  };
  ...
  e.prototype.isOpenChanged = function(e2) {
    ...
    if (e2) {
      if (this.itemsGroup.collapse == "single") {
        (t = this.itemsGroup) === null || t === void 0 ? void 0 : t.closeAll(this.numberElement);
      }
    }
  };
  e.prototype.componentWillLoad = function() {
    this.itemsGroup = this.element.parentElement.tagName == "BDS-NAV-TREE-GROUP" && this.element.parentElement;
    this.navTreeChild = this.element.querySelector("bds-nav-tree-item") === null ? false : true;
  };
  e.prototype.handleKeyDown = function(e2) {
    if (e2.key == "Enter" && !this.disable) {
      this.isOpen = !this.isOpen;
    }
  };
  e.prototype.render = function() {
    var e2, t, r, o, a, n, i;
    return h(Host, { key: "c3b83bc79738411d309fc031b8967cd559860685" }, h("div", { key: "1d5c99d78339a4a685d3bc3fe5d7ab1d6ea4b265", tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, h("div", { key: "a3c3232c515afc6ee51f253edc756421e464ae9d", class: (e2 = {}, e2["nav_main--disable"] = this.disable, e2) }, h("div", { key: "9b8b8025503db5afd800aa6d0764cd3bb28e45f7", onClick: this.handler, class: (t = { nav_main: true, nav_main_active: this.isOpen }, t["nav_main--loading"] = this.loading, t["nav_main--disable"] = this.disable, t), "data-test": this.dataTest, "aria-label": this.text + (this.secondaryText && ": ".concat(this.secondaryText)) }, this.loading ? h("bds-loading-spinner", { size: "extra-small" }) : this.icon ? h("bds-icon", { class: (r = {}, r["icon-item"] = true, r["icon-item-active"] = this.isOpen, r), size: "medium", name: this.icon, color: "inherit", theme: "outline" }) : "", h("div", { key: "f74e3435801872bdb295c4dae49cc67570ff1ec6", class: "nav_main_text" }, this.text && h("bds-typo", { key: "59acc4f6eeac7718d5ed43e218f53ef5e6327716", class: (o = {}, o["title-item"] = true, o["title-item--loading"] = this.loading, o), variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? "bold" : "semi-bold" }, this.text), this.secondaryText && h("bds-typo", { key: "b82578a514065a57a0d21accacb02287b1001fed", class: (a = {}, a["subtitle-item"] = true, a["subtitle-item--loading"] = this.loading, a), variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText)), h("div", { key: "463a467bb7358e6e4fb5dcb3592d9d23531d8d0b", class: "nav_main_content" }, h("slot", { key: "c62fc1631249715a74655f285bbcfcc90eceeeab", name: "header-content" })), this.navTreeChild && h("bds-icon", { key: "badd66942ffc608d2ff3fcda03e68a9c5f5c07ad", name: "arrow-down", class: (n = {}, n["nav_main_arrow"] = true, n["nav_main_arrow_active"] = this.isOpen, n["nav_main_arrow--loading"] = this.loading, n) })))), h("div", { key: "94d3f177c5f38acf3c20deffa720c8e102514ace", class: { accordion: true, accordion_open: this.isOpen && this.navTreeChild } }, h("div", { key: "436c06f2c9520de2b1c2c392f5ec6e4b50aa3431", class: (i = {}, i["container"] = true, i["container--disable"] = this.disable, i) }, h("slot", { key: "656f6ab4bf453b7cff42a5bed47275852a7c560c" }))));
  };
...
export {
  NavTree as bds_nav_tree
};
//# sourceMappingURL=bds-nav-tree.entry-CVVY4dR_.js.map
