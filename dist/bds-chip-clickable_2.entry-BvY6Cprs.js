...
var __awaiter = function(t, i, e, o) {
  function r(t2) {
    return t2 instanceof e ? t2 : new e(function(i2) {
      i2(t2);
    });
  }
  return new (e || (e = Promise))(function(e2, l) {
    function c(t2) {
      try {
        n(o.next(t2));
      } catch (t3) {
    ...
    function n(t2) {
      t2.done ? e2(t2.value) : r(t2.value).then(c, a);
    }
    n((o = o.apply(t, i || [])).next());
  });
};
var __generator = function(t, i) {
  ...
  function n(a2) {
    ...
    while (c && (c = 0, a2[0] && (e = 0)), e) try {
      if (o = 1, r && (l = a2[0] & 2 ? r["return"] : a2[0] ? r["throw"] || ((l = r["return"]) && l.call(r), 0) : r.next) && !(l = l.call(r, a2[1])).done) return l;
      if (r = 0, l) a2 = [a2[0] & 2, l.value];
      switch (a2[0]) {
        case 0:
        case 1:
          l = a2;
        ...
        case 7:
          ...
          continue;
        default:
          if (!(l = e.trys, l = l.length > 0 && l[l.length - 1]) && (a2[0] === 6 || a2[0] === 2)) {
            e = 0;
            continue;
          }
          if (a2[0] === 3 && (!l || a2[1] > l[0] && a2[1] < l[3])) {
            e.label = a2[1];
            break;
          }
          if (a2[0] === 6 && e.label < l[1]) {
            e.label = l[1];
            l = a2;
            break;
          }
...
var ChipClickable = function() {
  ...
  t.prototype.handleClickKey = function(t2) {
    if ((t2.key === "Enter" || t2.key === " ") && !this.disabled) {
      t2.preventDefault();
  ...
  t.prototype.handleCloseChip = function(t2) {
    t2.preventDefault();
    this.chipClickableClose.emit({ id: this.element.id });
  };
  t.prototype.handleCloseKey = function(t2) {
    if ((t2.key === "Enter" || t2.key === " ") && !this.disabled) {
      t2.preventDefault();
      this.chipClickableClose.emit({ id: this.element.id });
    }
  };
  t.prototype.getSizeAvatarChip = function() {
    if (this.size === "tall") {
      return "extra-small";
    } else return "micro";
  };
  t.prototype.getSizeIconChip = function() {
    if (this.size === "tall") {
      return "medium";
    } else return "x-small";
  };
...
var Tooltip = function() {
  ...
  t.prototype.invisible = function() {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(t2) {
        this.isMouseOver = false;
        return [2];
  ...
  t.prototype.setVisibility = function(t2) {
    if (this.disabled) {
      this.isMouseOver = false;
      return;
    }
  ...
  t.prototype.tooltipTextChanged = function() {
    this.textVerify = this.tooltipText ? this.tooltipText.replace(/<br>/gi, "\r\n") : "";
  };
  t.prototype.maxWidthChanged = function() {
    this.maxWidtTooltip = this.maxWidth;
  };
  t.prototype.render = function() {
    var t2;
    var i = this;
    var e = { maxWidth: this.maxWidtTooltip };
    return h("div", { key: "00b09b6886eb74ac91fbea2c9fbe3d792d5bd6cb", class: "tooltip__wrapper" }, h("div", { key: "e5026004be5450694921a9741f070f620dab6924", onMouseEnter: function() {
      return i.setVisibility(true);
    }, onMouseLeave: function() {
      return i.setVisibility(false);
    }, "data-test": this.dataTest }, h("slot", { key: "ea0363fa79c3ab2ee36cc0d981025a9dc51cf403" })), h("div", { key: "cb0da1586a8e66456295a212cfabb1e51831c123", class: (t2 = { tooltip__tip: true }, t2["tooltip__tip--".concat(this.position)] = true, t2["tooltip__tip--visible"] = this.isMouseOver, t2), style: e }, h("div", { key: "3c5bf7638affb6719452ed26d67675028cb39510", class: { tooltip__tip__text: true } }, h("pre", { key: "d330774b5fd7140bf3f7ccb75dc096f33162d587" }, h("bds-typo", { key: "df2356e9b99a38cb444ed77b283fdedd0c331770", class: "text", "no-wrap": "false", variant: "fs-12" }, this.textVerify)))));
  };
  Object.defineProperty(t, "watchers", { get: function() {
    return { tooltipText: ["tooltipTextChanged"], maxWidth: ["maxWidthChanged"] };
  }, enumerable: false, configurable: true });
  return t;
}();
Tooltip.style = tooltipCss;
export {
  ChipClickable as bds_chip_clickable,
  Tooltip as bds_tooltip
};
//# sourceMappingURL=bds-chip-clickable_2.entry-BvY6Cprs.js.map
