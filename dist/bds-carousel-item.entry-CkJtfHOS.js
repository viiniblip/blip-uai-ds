...
var carouselItemCss = ":host{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;width:auto}.carrosel-item-frame{display:block;width:100%;height:100%;border-radius:8px;position:relative;overflow:hidden}.carrosel-item-frame ::slotted(*){position:relative}.image-bg{position:absolute;width:100%;height:100%}";
var BdsCarouselItem = function() {
  function e(e2) {
...
export {
  BdsCarouselItem as bds_carousel_item
};
//# sourceMappingURL=bds-carousel-item.entry-CkJtfHOS.js.map
