...
var ChipTag = function() {
  ...
  t.prototype.render = function() {
    var t2;
    return h(Host, { key: "887254e094eb8da629197db22d1cf745d36c44eb" }, h("div", { key: "184c6b4bbe90f3c4db18c1f15fd7a4b5e103f423", class: (t2 = { chip_tag: true }, t2["chip_tag--".concat(this.color)] = true, t2), "data-test": this.dataTest }, this.icon && h("div", { key: "12c1fab15b6a7a95a34820c4300591976335230e", class: "chip_tag--icon" }, h("bds-icon", { key: "bc21e95c84cff8a0a648be069ee7c9c438c00f60", size: "x-small", name: this.icon })), h("div", { key: "a7aa8eac28bf01ab0d09ee995a0cd87fb6bc2ac1", class: this.icon ? "chip_tag--container-text--half" : "chip_tag--container-text--full" }, h("bds-typo", { key: "8782a444b3c56871c5001404f2fb8d966b9bffaa", "no-wrap": "true", class: "chip_tag--text", variant: "fs-12", bold: "bold" }, h("slot", { key: "058c4a53484962e98402be0db41bb0462afaa336" })))));
  };
  return t;
}();
ChipTag.style = chipTagCss;
export {
  ChipTag as bds_chip_tag
};
//# sourceMappingURL=bds-chip-tag.entry-FwVImldN.js.map
