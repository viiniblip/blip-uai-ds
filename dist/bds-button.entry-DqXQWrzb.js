...
var __awaiter = function(t, o, r, n) {
  function e(t2) {
    return t2 instanceof r ? t2 : new r(function(o2) {
      o2(t2);
    });
  }
  return new (r || (r = Promise))(function(r2, i) {
    ...
    function _(t2) {
      t2.done ? r2(t2.value) : e(t2.value).then(a, b);
    }
    _((n = n.apply(t, o || [])).next());
  });
};
var __generator = function(t, o) {
  ...
  function _(b2) {
    ...
    while (a && (a = 0, b2[0] && (r = 0)), r) try {
      if (n = 1, e && (i = b2[0] & 2 ? e["return"] : b2[0] ? e["throw"] || ((i = e["return"]) && i.call(e), 0) : e.next) && !(i = i.call(e, b2[1])).done) return i;
      if (e = 0, i) b2 = [b2[0] & 2, i.value];
      switch (b2[0]) {
        case 0:
        case 1:
          i = b2;
        ...
        case 7:
          ...
          continue;
        default:
          if (!(i = r.trys, i = i.length > 0 && i[i.length - 1]) && (b2[0] === 6 || b2[0] === 2)) {
            r = 0;
            continue;
          }
          if (b2[0] === 3 && (!i || b2[1] > i[0] && b2[1] < i[3])) {
            r.label = b2[1];
            break;
          }
          if (b2[0] === 6 && r.label < i[1]) {
            r.label = i[1];
            i = b2;
            break;
          }
...
var Button = function() {
  ...
  t.prototype.isActive = function(t2) {
  ...
  t.prototype.setPosition = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(o) {
        this.position = t2;
  ...
  t.prototype.setDirection = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(o) {
        this.direction = t2;
        return [2];
  ...
  t.prototype.setSize = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(o) {
        this.size = t2;
        return [2];
  ...
  t.prototype.setColor = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(o) {
        this.color = t2;
        return [2];
  ...
  t.prototype.setVariant = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(o) {
        this.variant = t2;
        return [2];
  ...
  t.prototype.buttonLegacy = function() {
    this.variant === "facebook" ? this.setVariant("outline") : this.setVariant(this.variant);
    this.size === "tall" ? this.setSize("large") : this.size === "standard" ? this.setSize("medium") : this.setSize(this.size);
  };
  t.prototype.logSlotText = function() {
    var t2 = this.el.shadowRoot.querySelector("slot");
    var o = this.el.shadowRoot.querySelector("button");
    if (t2) {
      var r = t2.assignedNodes();
      var n = "";
      ...
      if (n === "" && this.size === "medium") {
        o.classList.add("button__only-icon--medium");
      }
      if (n === "" && this.size === "large") {
        o.classList.add("button__only-icon--large");
      }
      if (n === "" && this.size === "short") {
        o.classList.add("button__only-icon--short");
      }
    }
  };
  ...
  t.prototype.handleClick = function(t2) {
    if (!this.disabled) {
      this.bdsClick.emit(t2);
      var o = this.el.closest("form");
      if (o) {
        t2.preventDefault();
  ...
  t.prototype.render = function() {
    var t2;
    var o = this;
    return h(Host, { key: "7339c555922e55b122fc2c081200798e0409393d", class: { host: true, block: this.block || this.fullWidth, group: this.group } }, h("div", { key: "b4944f21815aa4ea5ab836ed3781b27047406beb", tabindex: "0", onKeyDown: function(t3) {
      return o.handleClick(t3);
    }, class: "focus" }), h("button", { key: "17e1f11be43cf46d7a823a08a4cae74177de3b0f", disabled: this.disabled, tabindex: "-1", "aria-disabled": this.disabled ? "true" : "false", "aria-live": "assertive", type: this.type, class: (t2 = { button: true, "button--block": this.block, "button--full-width": this.fullWidth, "button--group": this.group }, t2["button__justify-content--".concat(this.justifyContent)] = true, t2["button__position--".concat(this.direction, "--").concat(this.position)] = true, t2["button--active"] = this.active, t2["button__variant--".concat(this.variant === "delete" ? "solid" : this.variant)] = true, t2["button__".concat(this.variant === "delete" ? "solid" : this.variant)] = true, t2["button__color--".concat(this.variant === "delete" ? "negative" : this.color)] = true, t2["button__variant--".concat(this.variant, "--disabled")] = this.disabled, t2["button__size--".concat(this.size)] = true, t2), part: "button", "data-test": this.dataTest }, this.bdsLoading ? this.renderLoadingSpinner() : "", this.groupIcon && (this.iconLeft || this.icon) ? h("div", { class: "button__group-content" }, h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.icon ? this.icon : this.iconLeft, theme: this.iconTheme, type: this.typeIcon, color: "inherit", size: "medium" }), h("bds-typo", { class: { typo_buttom: true, button__content: true, hide: this.bdsLoading }, variant: "fs-14", lineHeight: "simple", bold: "bold" }, h("slot", null))) : [this.iconLeft || this.icon ? h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.icon ? this.icon : this.iconLeft, theme: this.iconTheme, type: this.typeIcon, color: "inherit", size: "medium" }) : null, h("bds-typo", { class: { typo_buttom: true, button__content: true, hide: this.bdsLoading }, variant: "fs-14", lineHeight: "simple", bold: "bold" }, h("slot", null))], this.iconRight || this.arrow ? h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.arrow ? "arrow-right" : this.iconRight, color: "inherit", theme: this.iconTheme, type: this.typeIcon }) : ""));
  };
  Object.defineProperty(t.prototype, "el", { get: function() {
    return getElement(this);
  }, enumerable: false, configurable: true });
  Object.defineProperty(t, "watchers", { get: function() {
    return { bdsLoading: ["renderLoadingSpinner"] };
  }, enumerable: false, configurable: true });
  return t;
}();
Button.style = buttonCss;
export {
  Button as bds_button
};
//# sourceMappingURL=bds-button.entry-DqXQWrzb.js.map
