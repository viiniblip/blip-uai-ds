...
var InputPassword = function() {
  function t(t2) {
    ...
    this.toggleEyePassword = function() {
      if (!e.disabled) {
        e.openEyes = !e.openEyes;
      }
    };
    ...
    this.onInput = function(t3) {
      ...
      e.bdsInputPasswordInput.emit(t3);
    };
    this.onBlur = function() {
      e.bdsInputPasswordBlur.emit();
      e.isPressed = false;
    };
    this.onFocus = function() {
      e.bdsInputPasswordFocus.emit();
      e.isPressed = true;
    };
    this.onSubmit = function() {
      e.bdsInputPasswordSubmit.emit();
    };
    this.keyPressWrapper = function(t3) {
      switch (t3.key) {
        case "Enter":
          e.bdsInputPasswordSubmit.emit({ event: t3, value: e.value });
          break;
        case "Backspace":
        case "Delete":
          e.bdsKeyDownBackspace.emit({ event: t3, value: e.value });
          break;
      }
    };
  }
...
export {
  InputPassword as bds_input_password
};
//# sourceMappingURL=bds-input-password.entry-Dt-4O51a.js.map
