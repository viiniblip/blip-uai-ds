...
var __awaiter = function(e, t, i, r) {
  ...
  return new (i || (i = Promise))(function(i2, o) {
    ...
    function l(e2) {
      e2.done ? i2(e2.value) : n(e2.value).then(a, s);
    }
...
var __generator = function(e, t) {
  ...
  function l(s2) {
    ...
    while (a && (a = 0, s2[0] && (i = 0)), i) try {
      if (r = 1, n && (o = s2[0] & 2 ? n["return"] : s2[0] ? n["throw"] || ((o = n["return"]) && o.call(n), 0) : n.next) && !(o = o.call(n, s2[1])).done) return o;
      if (n = 0, o) s2 = [s2[0] & 2, o.value];
      switch (s2[0]) {
        case 0:
        case 1:
          o = s2;
...
var InputEditable = function() {
  function e(e2) {
    ...
    this.handleEditing = function() {
      t.toggleEditing();
    };
    this.toggleEditing = function() {
      t.isEditing = !t.isEditing;
    };
    this.handleSaveText = function() {
      var e3 = t.nativeInput.value;
      if (e3.length > 0 && e3.length >= t.minlength && !t.danger) {
        t.bdsInputEditableSave.emit({ value: e3, oldValue: t.oldValue });
        t.oldValue = e3;
        t.value = e3;
        t.toggleEditing();
      }
    };
    this.changedInputValue = function(e3) {
      return __awaiter(t, void 0, void 0, function() {
        ...
        return __generator(this, function(i) {
          ...
          this.checkValidity();
          if (t2) {
            if (t2.value.length < Number(this.minlength)) {
              this.isValid = false;
            } else {
              this.isValid = true;
            }
          }
          this.bdsInput.emit(e3);
  ...
  e.prototype.handleKeyDownToggle = function(e2) {
    if (e2.key == "Enter") {
      this.toggleEditing();
    }
  };
  e.prototype.handleKeyDownSave = function(e2) {
    if (e2.key == "Enter") {
      this.handleSaveText();
    }
  };
  e.prototype.getFontSizeClass = function() {
    if (this.size == "short") {
      return "fs-16";
  ...
  e.prototype.renderMessage = function() {
    var e2 = this.danger ? "error" : this.success ? "checkball" : "info";
    var t = this.danger ? this.errorMessage : this.success ? this.successMessage : this.helperMessage;
    if (!t && this.validationDanger) t = this.validationMesage;
    ...
    if (t) {
      return h("div", { class: i, part: "input__message" }, h("div", { class: "input__message__icon" }, h("bds-icon", { size: "x-small", name: e2, theme: "solid", color: "inherit" })), h("bds-typo", { class: "input__message__text", variant: "fs-12" }, t));
    }
    return void 0;
  };
  e.prototype.render = function() {
    var e2;
    var t = this;
    var i = this.getFontSizeClass();
    var r = this.getExpand();
    return h(Host, { key: "ecb3961c9c360654a75e1759ce29ed716de957bd" }, h("div", { key: "24cc54bc23ae2310ed0d03f51f84110ba9547ae6", class: "input__editable" }, h("div", { key: "c9ebeba13ff948ac24b11acdad08e9ff0e49b673", class: { "input__editable--static": true, "input__editable--hidden": this.isEditing }, onClick: this.handleEditing, "data-test": this.dtButtonEdit, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this) }, h("bds-typo", { key: "a2748be2510218abb9d4266867fa8d806698599c", tag: "span", part: "input__editable--static__typo", class: "input__editable--static__typo", variant: i }, this.value), h("bds-icon", { key: "edit-icon", class: "input__editable--static__icon", name: "edit" })), h("div", { key: "8ba4100236fa5cab2886f7303316e46c2ade6847", class: { "input__editable--active": true, "input__editable--hidden": !this.isEditing } }, h("div", { key: "ee596b546d3903f7918f4f7657489bf3cac2c496", class: (e2 = { element_input: true }, e2[r] = true, e2[this.size] = true, e2) }, h("div", { key: "73809ac824891288efe407f67d882a83f3c6109e", class: { input: true, select: true, "input--state-primary": !this.danger && !this.validationDanger, "input--state-danger": this.danger || this.validationDanger, "input--state-success": this.success, "input--pressed": this.isPressed }, onClick: this.onClickWrapper }, h("div", { key: "1ff805bb9c4f44ddf8d0f320a0c70184ea4fb639", class: "input__container" }, h("input", { key: "6864bc631c047afab2ee1787573cdc14d33f2edd", class: { input__container__text: true }, ref: function(e3) {
      return t.nativeInput = e3;
    }, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.changedInputValue, placeholder: this.placeholder, value: this.value, required: true, part: "input", "data-test": this.dataTest })), this.success && h("bds-icon", { key: "e5b7439e77d47de05388f490fbf9e45e16b2bb33", class: "icon-success", name: "checkball", theme: "solid", size: "xxx-small" })), this.renderMessage()), h("div", { key: "f19b1ac20779e5f4f6245a5cbe38774fd31edb7b", class: "input__editable--active__icon" }, h("bds-icon", { key: "error-icon", class: "input__editable--active__icon--error", theme: "solid", name: "error", onClick: this.handleEditing, tabindex: "0", onKeyDown: this.handleKeyDownToggle.bind(this), dataTest: this.dtButtonClose }), h("bds-icon", { key: "checkball-icon", class: { "input__editable--active__icon--checkball": true, "input__editable--active__icon--checkball--error": !this.isValid }, theme: "solid", name: "checkball", onClick: this.handleSaveText, tabindex: "0", onKeyDown: this.handleKeyDownSave.bind(this), dataTest: this.dtButtonConfirm })))));
  };
...
export {
  InputEditable as bds_input_editable
};
//# sourceMappingURL=bds-input-editable.entry-DcrDLG3T.js.map
