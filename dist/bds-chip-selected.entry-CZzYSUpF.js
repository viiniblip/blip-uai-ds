...
var ChipSelected = function() {
  ...
  e.prototype.getDisabledChip = function() {
    var e2;
    return this.disabled ? (e2 = { chip_disabled: true }, e2["chip_disabled--".concat(this.size)] = true, e2) : {};
  };
  e.prototype.getStyleChip = function() {
    var e2, t;
    return this.isSelected ? (e2 = { chip_selected: true }, e2["chip_selected--".concat(this.size)] = true, e2) : (t = {}, t["chip--".concat(this.color)] = true, t["chip--".concat(this.size)] = true, t);
  };
  e.prototype.getStyleText = function() {
    if (this.isSelected) {
      var e2 = { "chip_selected--text": true };
      return e2;
    }
  };
  e.prototype.getSizeIconChip = function() {
    if (this.size === "tall") {
      return "medium";
    } else return "x-small";
  };
...
export {
  ChipSelected as bds_chip_selected
};
//# sourceMappingURL=bds-chip-selected.entry-CZzYSUpF.js.map
