...
var __awaiter = function(e, t, o, n) {
  function c(e2) {
    return e2 instanceof o ? e2 : new o(function(t2) {
      t2(e2);
    });
  }
  return new (o || (o = Promise))(function(o2, i) {
    function r(e2) {
      try {
        a(n.next(e2));
      } catch (e3) {
    ...
    function a(e2) {
      e2.done ? o2(e2.value) : c(e2.value).then(r, s);
    }
...
var __generator = function(e, t) {
  ...
  function a(s2) {
    ...
    while (r && (r = 0, s2[0] && (o = 0)), o) try {
      if (n = 1, c && (i = s2[0] & 2 ? c["return"] : s2[0] ? c["throw"] || ((i = c["return"]) && i.call(c), 0) : c.next) && !(i = i.call(c, s2[1])).done) return i;
      if (c = 0, i) s2 = [s2[0] & 2, i.value];
      switch (s2[0]) {
        case 0:
        case 1:
          i = s2;
        ...
        case 7:
          ...
          continue;
        default:
          if (!(i = o.trys, i = i.length > 0 && i[i.length - 1]) && (s2[0] === 6 || s2[0] === 2)) {
            o = 0;
            continue;
          }
...
var Checkbox = function() {
  function e(e2) {
    ...
    this.onClick = function(e3) {
      ...
      t.bdsChange.emit({ checked: t.checked, indeterminate: t.indeterminate });
    };
    this.refNativeInput = function(e3) {
      t.nativeInput = e3;
    };
    this.getStyleState = function() {
      if (t.indeterminate && !t.disabled) {
    ...
    this.getIconName = function() {
      return t.indeterminate ? "less" : "true";
    };
  }
  e.prototype.connectedCallback = function() {
    this.checkBoxId = this.refer || "bds-checkbox-".concat(checkBoxIds++);
  };
  ...
  e.prototype.toggle = function() {
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(e2) {
        ...
        this.bdsChange.emit({ checked: this.checked, indeterminate: this.indeterminate });
        return [2];
      });
    });
  };
...
var SelectOption = function() {
  function e(e2) {
    ...
    this.checkedCurrent = function() {
      if (t.typeOption !== "checkbox") return;
      t.nativeInput.toggle();
    };
    this.onClickSelectOption = function() {
      if (t.typeOption == "checkbox") return;
      if (!t.disabled) {
        t.optionSelected.emit({ value: t.value, label: t.element.innerHTML });
      }
    };
    this.optionHandle = function(e3) {
      var o = e3.target;
      var n = { value: o.name, label: t.element.innerHTML, checked: o.checked };
      t.checked = !t.checked;
      t.optionChecked.emit(n);
    };
    this.attachOptionKeyboardListeners = function(e3) {
      var o = e3.target;
      switch (e3.key) {
        case "Enter":
          t.onClickSelectOption();
          break;
        case "ArrowDown":
          if (o.parentElement.nextElementSibling && !o.parentElement.nextElementSibling.hasAttribute("invisible")) {
            e3.preventDefault();
            e3.stopPropagation();
          ...
          break;
        case "ArrowUp":
          if (o.parentElement.previousElementSibling && !o.parentElement.previousElementSibling.hasAttribute("invisible")) {
            e3.preventDefault();
            e3.stopPropagation();
  ...
  e.prototype.changeSelectionType = function() {
  ...
  e.prototype.render = function() {
    var e2 = this;
    return h("div", { key: "5b7c2422b760789a14b01edb074d14a95ebf4d9b", id: "bds-select-option-".concat(this.value), "data-event": "click", role: "button", onKeyDown: this.attachOptionKeyboardListeners, onClick: this.onClickSelectOption, "data-value": this.value, "data-test": this.dataTest, class: { "select-option": this.typeOption != "checkbox", "select-option--selected": this.selected, "select-option--disabled": this.disabled, "select-option--invisible": this.invisible } }, h("div", { key: "d4398f3f076c9819e3801ecf422a36f60f337abf", style: { alignSelf: this.slotAlign } }, h("slot", { key: "107cdbe656c38de44bd58237a0425e1fd984f683", name: "input-left" })), h("div", { key: "30d79c0e46edbdeaee3fea51cbf3a6e31954f8ec", class: { "select-option__container": true, "select-option__container__fill_space": !!this.status, "select-option__container__checkbox": this.typeOption == "checkbox" }, onClick: function() {
      return e2.checkedCurrent();
    } }, this.titleText && h("bds-typo", { key: "961a3a61273eb6f68c2d6cba60497d6b64e999b6", class: "select-option__container--value", variant: "fs-16", bold: "semi-bold" }, this.titleText), this.typeOption === "checkbox" ? h("bds-checkbox", { ref: this.refNativeInput, refer: "html-for-".concat(this.value), label: this.element.innerHTML, name: this.value, checked: this.checked, onBdsChange: function(t) {
      return e2.optionHandle(t);
    } }) : h("bds-typo", { class: { "select-option__container--value": true, "select-option__container__overflow": !!this.status }, noWrap: !!this.status, variant: "fs-14" }, h("slot", null))), this.bulkOption && h("bds-typo", { key: "8344a83667a5a29dcc487c8bb8a3df1af3583d30", class: "select-option__container--bulk", variant: "fs-10" }, this.bulkOption), this.status && h("bds-typo", { key: "a4234b17ea814f502a485eea748e52091090bcf0", class: "select-option__container--status", noWrap: true, variant: "fs-10" }, this.status));
  };
  Object.defineProperty(e.prototype, "element", { get: function() {
    return getElement(this);
  }, enumerable: false, configurable: true });
  Object.defineProperty(e, "watchers", { get: function() {
    return { typeOption: ["changeSelectionType"] };
  }, enumerable: false, configurable: true });
  return e;
}();
SelectOption.style = selectOptionCss;
export {
  Checkbox as bds_checkbox,
  SelectOption as bds_select_option
};
//# sourceMappingURL=bds-checkbox_2.entry-B-oisp3_.js.map
