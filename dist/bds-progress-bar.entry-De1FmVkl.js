...
var BdsProgressBar = function() {
  ...
  r.prototype.render = function() {
    var r2, e;
    var o = { width: "".concat(this.percent ? this.percent > 100 ? 100 : this.percent : 0, "%") };
    return h(Host, { key: "45260bbac205b7cefca95e995efdb19dc7cf0591" }, h("div", { key: "69bb68554d05b6469af65023032ffb1660f57fcd", class: (r2 = { progress_bar: true }, r2["size_".concat(this.size)] = true, r2), "data-test": this.dataTest }, h("div", { key: "99397107698489eaa05b238de95feea5db0a1250", class: { bar_behind: true } }, h("div", { key: "a02424dbec319b1fa284a15f5808b892b63e46b2", class: (e = { progress: true }, e["color_".concat(this.color)] = true, e), style: o }))), this.text && h("div", { key: "4e0e00f2703d7f80c97ad65ad665b9d402d66945", class: { typo_progress: true } }, h("bds-typo", { key: "7c099b19eeeebfbd70dde18a594299d6666f4509", variant: "fs-14" }, this.text)));
  };
  return r;
}();
BdsProgressBar.style = progressBarCss;
export {
  BdsProgressBar as bds_progress_bar
};
//# sourceMappingURL=bds-progress-bar.entry-De1FmVkl.js.map
