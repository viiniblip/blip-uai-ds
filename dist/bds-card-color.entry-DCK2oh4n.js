...
var CardColor = function() {
  function o(o2) {
    ...
    this.handleCopyVariable = function(o3) {
      var c = "$".concat(o3);
  ...
  o.prototype.render = function() {
    var o2;
    var r = this;
    return h("bds-paper", { key: "a899922aee333016222e09ffdd6fcb8ded2d7f8b", class: "card", width: "240px", height: "140px", onClick: function() {
      return r.handleCopyVariable(r.variable);
    } }, h("bds-grid", { key: "312992180a07b30d6911aba4bce71a2a8adeaa7e", direction: "column", height: "100%" }, h("bds-grid", { key: "6c7778937650370b14fd367492f0fd06901dd9a5", height: "70%", xxs: "12", class: (o2 = { "card-color--color": true }, o2["card-color--".concat(this.variable)] = true, o2) }), h("bds-grid", { key: "8fe88497bab0f9849c9246f1f87f044cc752ed21", "justify-content": "center", "align-items": "center", height: "30%" }, !this.showMessage ? h("bds-typo", { class: "card-text", variant: "fs-14", bold: "bold" }, "$", this.variable) : h("bds-typo", { class: "card-text-copie", variant: "fs-14", bold: "bold" }, "Cor copiada!"))));
  };
  return o;
}();
CardColor.style = cardColorCss;
export {
  CardColor as bds_card_color
};
//# sourceMappingURL=bds-card-color.entry-DCK2oh4n.js.map
