...
var expansionPanelHeaderCss = ":host{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}.header{width:70px;padding-right:6px}";
var ExpansionPanelHeader = function() {
  function e(e2) {
...
export {
  ExpansionPanelHeader as bds_expansion_panel_header
};
//# sourceMappingURL=bds-expansion-panel-header.entry-C63TccSx.js.map
