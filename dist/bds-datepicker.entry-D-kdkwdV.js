...
import { d as dateToInputDate, a as defaultStartDate, b as dateToDayList, c as defaultEndDate, f as fillDayList, e as dateToTypeDate, t as termTranslate, g as typeDateToStringDate, m as messageTranslate } from "./calendar-DL5vi8uh-AoMaXok7.js";
import { d as dateValidation } from "./validations-BXYXNVip-LcA-EPqi.js";
...
var DatePicker = function() {
  function e(e2) {
    ...
    this.centerDropElement = function(e3) {
      var i = e3.split("-");
      if ((i[0] == "left" || i[0] == "right") && i[1] == "center") {
        t.menuElement.style.top = "calc(50% - ".concat(t.menuElement.offsetHeight / 2, "px)");
      }
    };
    this.refMenuElement = function(e3) {
      t.menuElement = e3;
    };
    this.refInputSetDate = function(e3) {
      t.inputSetDate = e3;
    };
    this.refInputSetEndDate = function(e3) {
      t.inputSetEndDate = e3;
    };
    this.refDatepickerPeriod = function(e3) {
      t.datepickerPeriod = e3;
    };
    this.refDatepickerSingle = function(e3) {
      t.datepickerSingle = e3;
    };
    this.clearDate = function() {
      t.valueDate = null;
      t.bdsStartDate.emit({ value: null });
      if (t.typeOfDate == "single") {
        t.datepickerSingle.clear();
      } else {
        t.datepickerPeriod.clear();
        t.valueEndDate = null;
        t.bdsEndDate.emit({ value: null });
        setTimeout(function() {
          var e3;
          (e3 = t.inputSetDate) === null || e3 === void 0 ? void 0 : e3.setFocus();
        }, 10);
      }
    };
    this.onInputDateSelected = function(e3) {
      var i = e3.target;
      t.valueDate = i.value;
      if (!t.valueDate) {
        t.valueEndDate = null;
      }
      t.validationDateSelected(t.valueDate);
    };
    this.validationDateSelected = function(e3) {
      var i = typeDateToStringDate(e3);
      var r = i && dateToDayList(i);
      var a = t.startDateLimit && dateToDayList(t.startDateLimit);
      var o = t.endDateLimit && dateToDayList(t.endDateLimit);
      if (!dateValidation(i)) {
        t.errorMsgDate = "".concat(messageTranslate(t.language, "dateFormatIsIncorrect"), "!");
      } else {
        if (fillDayList(r) < fillDayList(a) || fillDayList(r) > fillDayList(o)) {
          t.errorMsgDate = "".concat(messageTranslate(t.language, "betweenPeriodOf"), " ").concat(t.startDateLimit, " - ").concat(t.endDateLimit);
        } else {
          t.errorMsgDate = null;
          t.dateSelected = new Date(r.year, r.month, r.date);
        }
      }
    };
    this.onInputEndDateSelected = function(e3) {
      var i = e3.target;
      t.valueEndDate = i.value;
      t.validationEndDateSelected(t.valueEndDate);
    };
    this.validationEndDateSelected = function(e3) {
      var i = typeDateToStringDate(e3);
      var r = typeDateToStringDate(t.valueDate);
      var a = i && dateToDayList(i);
      var o = r ? dateToDayList(r) : dateToDayList(t.startDateLimit);
      var n = t.endDateLimit && dateToDayList(t.endDateLimit);
      if (!dateValidation(i)) {
        t.errorMsgEndDate = "".concat(messageTranslate(t.language, "dateFormatIsIncorrect"), "!");
      } else {
        if (fillDayList(a) < fillDayList(o) || fillDayList(a) > fillDayList(n)) {
          t.errorMsgEndDate = "".concat(messageTranslate(t.language, "betweenPeriodOf"), " ").concat(r, " - ").concat(t.endDateLimit);
        } else {
          t.errorMsgEndDate = null;
          t.endDateSelected = new Date(a.year, a.month, a.date);
        }
      }
    };
    ...
    this.clickConcludeDatepicker = function() {
      if (t.typeOfDate == "period") {
        if (t.valueEndDate) {
          var e3 = { startDate: typeDateToStringDate(t.valueDate), endDate: typeDateToStringDate(t.valueEndDate) };
          t.open = false;
          t.concludeDatepicker.emit(e3);
          t.inputSetEndDate.removeFocus();
          t.errorMsgEndDate = null;
        } else {
          if (!t.valueDate && !t.valueEndDate) {
            t.open = false;
            t.emptyConcludeDatepicker.emit();
          } else {
            t.open = true;
            t.errorMsgEndDate = messageTranslate(t.language, "endDateIsEmpty");
          }
        }
      } else {
        if (t.valueDate != null) {
          var e3 = { startDate: typeDateToStringDate(t.valueDate) };
          t.concludeDatepicker.emit(e3);
        }
        t.open = false;
      }
    };
    this.onFocusDateSelect = function() {
      t.stateSelect = "start";
    };
    this.onFocusEndDateSelect = function() {
      t.stateSelect = "end";
    };
  }
  ...
  e.prototype.valueDateSelectedChanged = function() {
    this.valueDate = this.valueDateSelected && dateToInputDate(this.valueDateSelected);
    if (this.valueDate) this.validationDateSelected(this.valueDate);
  };
  e.prototype.valueEndDateSelectedChanged = function() {
    this.valueEndDate = this.valueEndDateSelected && dateToInputDate(this.valueEndDateSelected);
    if (this.valueEndDate) this.validationEndDateSelected(this.valueEndDate);
  };
  e.prototype.startDateLimitChanged = function() {
    if (!dateValidation(this.startDateLimit)) {
      this.startDateLimit = defaultStartDate;
    }
  };
  e.prototype.endDateLimitChanged = function() {
    var e2 = dateToDayList(this.startDateLimit);
    var t = dateToDayList(this.endDateLimit);
    if (!dateValidation(this.endDateLimit)) {
      this.endDateLimit = defaultEndDate;
    }
    if (fillDayList(t) < fillDayList(e2)) {
      this.endDateLimit = "".concat(t.date.toString().padStart(2, "0"), "/").concat((t.month + 1).toString().padStart(2, "0"), "/").concat(e2.year + 1);
    }
  };
  e.prototype.dateSelectedChanged = function() {
    this.stateSelect = "end";
  };
  e.prototype.setDefaultPlacement = function(e2) {
    if (this.typeOfDate == "single") {
      this.menuElement.classList.add("datepicker__menu__single__".concat(e2));
    } else {
      this.menuElement.classList.add("datepicker__menu__period__".concat(e2));
    }
  };
  e.prototype.validatePositionDrop = function() {
    var e2 = positionAbsoluteElement({ actionElement: this.element, changedElement: this.menuElement, intoView: this.intoView });
    if (this.typeOfDate == "single") {
      this.menuElement.classList.add("datepicker__menu__single__".concat(e2.y, "-").concat(e2.x));
    } else {
      this.menuElement.classList.add("datepicker__menu__period__".concat(e2.y, "-").concat(e2.x));
    }
  };
  e.prototype.whenClickCalendar = function(e2) {
    var t;
    var i = e2.detail.value;
    if (i == "start") {
      (t = this.inputSetEndDate) === null || t === void 0 ? void 0 : t.setFocus();
    }
  };
  e.prototype.selectDate = function(e2) {
    var t = e2.detail.value;
    this.dateSelected = t;
    this.bdsStartDate.emit({ value: this.dateSelected });
    this.valueDate = this.dateSelected && dateToTypeDate(this.dateSelected);
    this.errorMsgDate = null;
  };
  e.prototype.selectEndDate = function(e2) {
    var t = e2.detail.value;
    this.endDateSelected = t;
  ...
  e.prototype.render = function() {
    var e2, t;
    var i = this;
    return h(Host, { key: "36bbc9c4e45662cd85aa8be8369cf782a2547e30", class: { datepicker: true } }, this.typeOfDate == "single" ? h("div", { class: (e2 = { datepicker__inputs: true }, e2["datepicker__inputs__".concat(this.typeOfDate)] = true, e2.datepicker__inputs__open = this.open, e2) }, h("bds-input", { class: "input-start", label: this.label.length > 0 ? this.label : termTranslate(this.language, "setTheDate"), value: this.valueDate, disabled: this.disabled, type: "date", maxlength: 10, icon: "calendar", onClick: function() {
      return i.openDatepicker();
    }, onBdsInput: function(e3) {
      return i.onInputDateSelected(e3.detail);
    }, danger: this.errorMsgDate ? true : false, errorMessage: this.errorMsgDate, dataTest: this.dtInputStart })) : h("div", { class: (t = { datepicker__inputs: true }, t["datepicker__inputs__".concat(this.typeOfDate)] = true, t.datepicker__inputs__open = this.open, t) }, h("bds-input", { class: "input-start", ref: this.refInputSetDate, label: termTranslate(this.language, "from"), value: this.valueDate, disabled: this.disabled, type: "date", maxlength: 10, icon: "calendar", onClick: function() {
      return i.openDatepicker();
    }, onFocus: function() {
      return i.onFocusDateSelect();
    }, onBdsInput: function(e3) {
      return i.onInputDateSelected(e3.detail);
      ...
      return i.onFocusEndDateSelect();
    }, onBdsInput: function(e3) {
      return i.onInputEndDateSelected(e3.detail);
    }, danger: this.errorMsgEndDate ? true : false, errorMessage: this.errorMsgEndDate, dataTest: this.dtInputEnd })), h("div", { key: "0b89b98494daeafb830545eef3d0133ffd778404", ref: this.refMenuElement, class: { datepicker__menu: true, datepicker__menu__open: this.open } }, this.message && h("bds-grid", { key: "f8af1bc791126b3ed89395fbdc856ad4e056c33c", margin: "b-2" }, h("bds-banner", { key: "333e8b53d22a4f03ad6e4cc8be66afb44da11561", variant: this.variantBanner, context: "inside" }, this.message)), this.typeOfDate == "single" ? h("bds-datepicker-single", { ref: this.refDatepickerSingle, startDate: this.startDateLimit && dateToDayList(this.startDateLimit), endDate: this.endDateLimit && dateToDayList(this.endDateLimit), dateSelect: this.dateSelected, onBdsDateSelected: function(e3) {
      return i.selectDate(e3);
    }, language: this.language, dtButtonPrev: this.dtButtonPrev, dtButtonNext: this.dtButtonNext, dtSelectMonth: this.dtSelectMonth, dtSelectYear: this.dtSelectYear }) : h("bds-datepicker-period", { ref: this.refDatepickerPeriod, startDate: this.startDateLimit && dateToDayList(this.startDateLimit), endDate: this.endDateLimit && dateToDayList(this.endDateLimit), startDateSelect: this.dateSelected, stateSelect: this.stateSelect, endDateSelect: this.endDateSelected, onBdsStartDate: function(e3) {
      return i.selectDate(e3);
    }, onBdsEndDate: function(e3) {
      return i.selectEndDate(e3);
    }, onBdsClickDayButton: function(e3) {
      return i.whenClickCalendar(e3);
    }, language: this.language, dtButtonPrev: this.dtButtonPrev, dtButtonNext: this.dtButtonNext, dtSelectMonth: this.dtSelectMonth, dtSelectYear: this.dtSelectYear }), h("div", { key: "93b725249db0b8b9d48b95aa2ab5c6af3c461de6", class: { datepicker__menu__footer: true } }, h("bds-button", { key: "c9d02f6676f7c7526657470c32b921f6ad9f5b39", class: "bt-reset", size: "short", variant: "secondary", onClick: function() {
      return i.clearDate();
    }, dataTest: this.dtButtonClear }, termTranslate(this.language, "reset")), h("bds-button", { key: "c77167272845dada97a46af9273de62d08c258b5", class: "bt-conclude", size: "short", onClick: this.clickConcludeDatepicker, dataTest: this.dtButtonConfirm }, termTranslate(this.language, "conclude")))), this.open && h("div", { key: "c0725214a7c73afb99d9a403ec0f8bf91d4c09f2", class: { outzone: true }, onClick: function() {
      return i.clickConcludeDatepicker();
  ...
  Object.defineProperty(e, "watchers", { get: function() {
    return { valueDateSelected: ["valueDateSelectedChanged"], valueEndDateSelected: ["valueEndDateSelectedChanged"], startDateLimit: ["startDateLimitChanged"], endDateLimit: ["endDateLimitChanged"], dateSelected: ["dateSelectedChanged"] };
  }, enumerable: false, configurable: true });
  return e;
}();
DatePicker.style = datepickerCss;
export {
  DatePicker as bds_datepicker
};
//# sourceMappingURL=bds-datepicker.entry-D-kdkwdV.js.map
