...
var BdsAvatar = function() {
  function a(a2) {
    ...
    this.ellipsis = null;
    this.dataTest = null;
    this.handleOpenUpload = function(a3) {
      var e = t.el.shadowRoot.getElementById("file-input");
      if (a3.type === "click" || a3.type === "keydown" && (a3.key === "Enter" || a3.key === " ")) {
        e.click();
      }
    };
    this.selectTypoSize = function(a3) {
      switch (a3) {
        case "micro":
          t.typoSize = "fs-12";
          t.iconSize = "xx-small";
    ...
    this.avatarBgColor = function(a3) {
      if (t.color != "colorLetter") {
        return t.color;
      } else if (a3) {
        var e = colorLetter.find(function(t2) {
          return t2.value === a3;
        });
        return e.color;
      }
  ...
  a.prototype.onUploadClick = function(a2) {
    a2.preventDefault();
    this.bdsClickAvatar.emit(a2);
    if (this.openUpload) {
      this.handleOpenUpload(a2);
    }
  };
  a.prototype.onFileInputChange = function(a2) {
    var t = this;
    var e = a2.target;
    var r = e.files;
    if (r && r.length > 0) {
      ...
      o.onload = function(a3) {
        var e2 = a3.target.result;
        t.thumbnail = e2;
        t.bdsImageUpload.emit(e2);
      };
      o.readAsDataURL(i);
    }
  };
  a.prototype.componentWillRender = function() {
    this.hasThumb = this.thumbnail ? this.thumbnail.length !== 0 ? true : false : false;
  };
  a.prototype.render = function() {
    var a2;
    var t = this;
    var e = this.name ? this.name.split(" ") : [];
    var r = e.length ? e.shift().charAt(0).toUpperCase() : "";
    var i = e.length ? e.pop().charAt(0).toUpperCase() : "";
    this.selectTypoSize(this.size);
    var o = { backgroundImage: "url(".concat(this.hasThumb ? this.thumbnail : null, ")") };
    return h(Host, { key: "05ce48cc57cd10eed34e8aaceffd22fa94e9a96f" }, h("input", { key: "cdf19a2ed099f95bf9b498d2fa6653f213dc0381", type: "file", id: "file-input", accept: "image/*", onChange: function(a3) {
      return t.onFileInputChange(a3);
    }, style: { display: "none" } }), h("div", { key: "21496595eeb3a27c882dc4600450eef4f50c18eb", class: (a2 = { avatar: true }, a2["avatar__color--".concat(this.name && !this.hasThumb ? this.avatarBgColor(r) : this.hasThumb && !this.name ? "surface" : !this.name && !this.hasThumb ? "surface" : this.name && this.hasThumb ? this.avatarBgColor(r) : null)] = true, a2["avatar__size--".concat(this.size)] = true, a2.upload = this.upload || this.openUpload, a2), onClick: function(a3) {
      return t.onUploadClick(a3);
    }, tabindex: "0", onKeyDown: function(a3) {
      return t.onUploadClick(a3);
    }, "data-test": this.dataTest }, this.ellipsis ? h("div", { class: "avatar__btn" }, h("bds-typo", { margin: false, variant: this.typoSize, tag: "span" }, "+".concat(this.ellipsis))) : this.thumbnail ? this.upload || this.openUpload ? h("div", { class: "avatar__btn" }, h("div", { class: "avatar__btn__img avatar__size--".concat(this.size), style: o }), h("div", { class: "avatar__btn__thumb" }, h("bds-icon", { class: "avatar__btn__thumb__icon", name: "upload", theme: "outline", size: this.iconSize }))) : h("div", { class: "avatar__btn" }, h("div", { class: "avatar__btn__img avatar__size--".concat(this.size), style: o })) : this.name ? this.upload || this.openUpload ? h("div", { class: "avatar__btn" }, h("bds-typo", { margin: false, class: "avatar__btn__text", variant: this.typoSize, tag: "span" }, r + i), h("div", { class: "avatar__btn__name" }, h("bds-icon", { class: "avatar__btn__name__icon", name: "upload", theme: "outline", size: this.iconSize }))) : h("div", { class: "avatar__btn" }, h("bds-typo", { margin: false, class: "avatar__text", variant: this.typoSize, tag: "span" }, r + i)) : this.upload || this.openUpload ? h("div", { class: "avatar__btn" }, h("bds-icon", { class: "avatar__btn__icon", name: "user-default", theme: "outline", size: this.iconSize }), h("div", { class: "avatar__btn__empty" }, h("bds-icon", { class: "avatar__btn__empty__icon", name: "upload", theme: "outline", size: this.iconSize }))) : this.name === null && !this.hasThumb ? h("div", { class: "avatar__btn" }, h("bds-icon", { class: "avatar__icon", name: "user-default", theme: "outline", size: this.iconSize })) : ""));
  };
...
export {
  BdsAvatar as bds_avatar
};
//# sourceMappingURL=bds-avatar.entry-MXqtjMl-.js.map
