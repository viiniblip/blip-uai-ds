...
var InputChips = function() {
    ...
    this.keyPressWrapper = function(t3) {
      switch (t3.key) {
        case "Enter":
          ...
          i.setChip(i.value);
          i.value = "";
          i.bdsChange.emit({ data: i.internalChips, value: i.getLastChip() });
          i.bdsChangeChips.emit({ data: i.internalChips, value: i.getLastChip() });
          break;
        case "Backspace":
        case "Delete":
  ...
  t.prototype.getLastChip = function() {
  ...
  t.prototype.renderChips = function() {
    ...
    return this.internalChips.map(function(i, e) {
      ...
      if (i.length <= n) {
        ...
        }, dtButtonClose: t2.dtButtonClose }, i);
      } else {
        return h("bds-tooltip", { key: r, position: "top-center", "tooltip-text": i }, h("bds-chip-clickable", { id: r, key: r, color: "outline", close: !t2.disabled, onChipClickableClose: function(i2) {
          return t2.removeChip(i2);
        }, dtButtonClose: t2.dtButtonClose }, "".concat(i.slice(0, n), "...")));
      }
    });
  };
