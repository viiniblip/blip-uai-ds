...
var __awaiter = function(e, t, r, o) {
  function a(e2) {
  ...
  return new (r || (r = Promise))(function(r2, n) {
    ...
    function c(e2) {
      e2.done ? r2(e2.value) : a(e2.value).then(i, s);
    }
...
var __generator = function(e, t) {
  ...
  function c(s2) {
    ...
    while (i && (i = 0, s2[0] && (r = 0)), r) try {
      if (o = 1, a && (n = s2[0] & 2 ? a["return"] : s2[0] ? a["throw"] || ((n = a["return"]) && n.call(a), 0) : a.next) && !(n = n.call(a, s2[1])).done) return n;
      ...
      switch (s2[0]) {
        ...
        case 7:
          ...
          continue;
        default:
          if (!(n = r.trys, n = n.length > 0 && n[n.length - 1]) && (s2[0] === 6 || s2[0] === 2)) {
            r = 0;
            continue;
          }
...
var NavTreeItem = function() {
  function e(e2) {
    ...
    this.handler = function() {
      if (!t.loading && !t.disable) {
        if (t.navTreeParent && t.navTreeParent.collapse == "single" && t.itensElement) {
          for (var e3 = 0; e3 < t.itensElement.length; e3++) {
            if (t.itensElement[e3] != t.element) t.itensElement[e3].isOpen = false;
          }
        }
        t.toggle();
      }
  ...
  e.prototype.isOpenChanged = function(e2) {
    this.bdsToogleChange.emit({ value: e2, element: this.element });
  };
  e.prototype.componentWillLoad = function() {
    var e2, t;
    this.navTreeParent = ((e2 = this.element.parentElement) === null || e2 === void 0 ? void 0 : e2.tagName) == "BDS-NAV-TREE" && this.element.parentElement || ((t = this.element.parentElement) === null || t === void 0 ? void 0 : t.tagName) == "BDS-NAV-TREE-ITEM" && this.element.parentElement || null;
  ...
  e.prototype.render = function() {
    var e2, t, r, o, a;
    var n = this;
    return h(Host, { key: "e118bf10bd6864eb4a9dc5b67107ec56910d62ea" }, h("div", { key: "a832a417ea8879d21d1f648c4cc760a420dc7626", tabindex: "0", onKeyDown: this.handleKeyDown.bind(this), class: "focus" }, h("div", { key: "6659deea843284153e031994f86ea8288f349258", class: (e2 = { nav_tree_item: true, nav_tree_item_active: this.isOpen, nav_tree_item_button: !this.navTreeChild, nav_tree_item_button_active: !this.navTreeChild && this.isOpen }, e2["nav_tree_item--loading"] = this.loading, e2["nav_tree_item--disable"] = this.disable, e2), onClick: function() {
      return n.handler();
    }, "data-test": this.dataTest, "aria-label": this.text + (this.secondaryText && ": ".concat(this.secondaryText)) }, this.loading ? h("bds-loading-spinner", { size: "extra-small" }) : this.icon ? h("bds-icon", { class: (t = {}, t["icon-item"] = true, t["icon-item-active"] = this.isOpen, t), size: "medium", name: this.icon, color: "inherit", theme: "outline" }) : "", h("div", { key: "1584948e66adf30b48c8c0e98e01ca8320db0e69", class: "nav_tree_item_content" }, this.text && h("bds-typo", { key: "ff7d580f9758aaf069e748a6db27d16e0c743f7f", class: (r = {}, r["title-item"] = true, r["title-item--loading"] = this.loading, r), variant: "fs-14", tag: "span", "line-height": "small", bold: this.isOpen ? "bold" : "semi-bold" }, this.text), this.secondaryText && h("bds-typo", { key: "7ec40762f3ffdf24b7905a366d52c6dba30ecf8d", class: (o = {}, o["subtitle-item"] = true, o["subtitle-item--loading"] = this.loading, o), variant: "fs-12", "line-height": "small", tag: "span", margin: false }, this.secondaryText)), h("div", { key: "f575665cc68beb46a500cde8ef1ead79da69c5bd", class: "nav_tree_item_slot" }, h("slot", { key: "2791dffc6c055710d25c2755486dad8b3312fac6", name: "header-content" })), this.navTreeChild && h("bds-icon", { key: "dbd73505cc9598bced4ac1a64c0f76aa9201766c", class: (a = {}, a["nav_main_arrow"] = true, a["nav_main_arrow_active"] = this.isOpen, a["nav_main_arrow--loading"] = this.loading, a), name: "arrow-down" }))), this.navTreeChild && h("div", { key: "921344dcc511c31c2b1e44f65f3bc6a30e206a0b", class: { accordion: true, accordion_open: this.isOpen } }, h("div", { key: "249bce6e0c8442a0a7cbc0e2b073e2c14ad3faaa", class: "container" }, h("slot", { key: "ad21aed4acd1dd754ecc2fc5a9d368dfdbda7f96" }))));
  };
...
export {
  NavTreeItem as bds_nav_tree_item
};
//# sourceMappingURL=bds-nav-tree-item.entry-DjTse4Xh.js.map
