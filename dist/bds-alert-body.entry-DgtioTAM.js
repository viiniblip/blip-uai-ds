...
var alertBodyCss = ".alert__body{position:relative;width:100%;padding:12px 16px;margin-bottom:8px;-webkit-box-sizing:border-box;box-sizing:border-box}";
...
export {
  AlertBody as bds_alert_body
};
//# sourceMappingURL=bds-alert-body.entry-DgtioTAM.js.map
