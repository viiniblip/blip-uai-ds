...
var Select = function() {
  function t(t2) {
    ...
    this.dataTest = null;
    this.refNativeInput = function(t3) {
      e.nativeInput = t3;
    };
    ...
    this.getText = function(t3) {
      var i;
      var o = e.childOptions.find(function(e2) {
        return e2.value == t3;
      });
      if (e.internalOptions) {
        var r = e.internalOptions.find(function(t4) {
          return t4.value == (o === null || o === void 0 ? void 0 : o.value);
        });
        if (r) {
          return r.titleText ? r.titleText : r.label;
        }
      }
      return (o === null || o === void 0 ? void 0 : o.titleText) ? o === null || o === void 0 ? void 0 : o.titleText : (i = o === null || o === void 0 ? void 0 : o.innerText) !== null && i !== void 0 ? i : "";
    };
  ...
  t.prototype.handleWindow = function(t2) {
    var e = this;
    var i = t2.composedPath();
    if (!i.find(function(t3) {
      return t3 == e.el;
    })) {
      this.isOpen = false;
    }
  ...
  t.prototype.getValueSelected = function() {
    for (var t2 = 0, e = this.childOptions; t2 < e.length; t2++) {
      var i = e[t2];
      i.selected = this.value === i.value;
  ...
  t.prototype.keyPressWrapper = function(t2) {
    ...
    switch (t2.key) {
      ...
      case "ArrowUp":
        ...
        this.value = (r = this.el.lastElementChild) === null || r === void 0 ? void 0 : r.value;
        break;
    }
  };
  ...
  t.prototype.render = function() {
    var t2 = this;
    var e = this.isPressed && !this.disabled;
    return h("div", { key: "5b257abab1684e682b2e5a4ece279838ded86426", class: "select" }, h("div", { key: "076dac2ca0f3067b38c428e4a0bd5df9882fcbaa", class: { element_input: true }, "aria-disabled": this.disabled ? "true" : null }, h("div", { key: "bd64f6afe771e27f66200db9ed1f42f5e32ce87c", class: { input: true, "input--state-primary": !this.danger && !this.validationDanger, "input--state-danger": this.danger || this.validationDanger, "input--state-success": this.success, "input--state-disabled": this.disabled, "input--label": !!this.label, "input--pressed": e }, onClick: this.onClickWrapper, part: "input-container" }, this.renderIcon(), h("div", { key: "9c940b2ac9b9713055d5b5c260fe5d21e19dfad8", class: "input__container" }, this.renderLabel(), h("div", { key: "74ec281d8636c121e10e7fb7885d47888c2692fd", class: { input__container__wrapper: true } }, h("input", { key: "f962d90b9e465c81848f460bcd40d6868643f3a0", ref: this.refNativeInput, class: { input__container__text: true }, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, placeholder: this.placeholder, readonly: true, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), h("div", { key: "6c493aaf4bc617ea4694e15a4495ebb8d5a66031", class: "select__icon" }, h("bds-icon", { key: "b22854217a0a2c790c1ed37adfdd2f0a2ab5e231", ref: function(e2) {
      return t2.refIconDrop(e2);
    }, size: "small", color: "inherit" })), this.success && h("bds-icon", { key: "706bc4903f5c844cdf1b5a567e4b0c1651198c81", class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), h("div", { key: "23e7d8e882712901a58228f82e6ccbfbc42893f5", ref: function(e2) {
      return t2.refDropdown(e2);
    }, class: { select__options: true, "select__options--open": this.isOpen }, role: "application" }, this.internalOptions ? this.internalOptions.map(function(t3, e2) {
      return t3.icon || t3.titleText ? h("bds-select-option", { key: e2, value: t3.value, "title-text": t3.titleText, "slot-align": t3.slotAlign, bulkOption: t3.bulkOption, status: t3.status }, t3.icon && h("bds-icon", { slot: "input-left", name: t3.icon, size: "medium", color: t3.iconColor }), t3.label) : h("bds-select-option", { key: e2, value: t3.value, bulkOption: t3.bulkOption, status: t3.status }, t3.label);
    }) : h("slot", null)));
  };
  ...
  Object.defineProperty(t, "watchers", { get: function() {
    return { isOpen: ["isOpenChanged"], value: ["valueChanged"], options: ["optionsChanged"] };
  }, enumerable: false, configurable: true });
  return t;
}();
Select.style = selectCss;
export {
  Select as bds_select
};
//# sourceMappingURL=bds-select.entry-Bw-6kRCU.js.map
