...
var IconButton = function() {
  function o(o2) {
    ...
    this.icon = null;
    this.dataTest = null;
    this.mapSize = { tall: "xxx-large", standard: "x-large", short: "medium" };
    this.mapVariantStyle = { primary: "icon__button--primary", secondary: "icon__button--secondary", tertiary: "icon__button--tertiary", delete: "icon__button--delete", ghost: "icon__button--ghost", "secondary--white": "icon__button--secondary-white" };
    this.handleClick = function(o3) {
      if (!t.disabled) {
        t.bdsClick.emit(o3);
      }
    };
  ...
  o.prototype.render = function() {
    ...
    var n = this.mapSize[this.size];
    var r = this.mapVariantStyle[this.variant];
    return h("button", { onClick: function(o3) {
      return t.handleClick(o3);
    }, disabled: this.disabled, class: (o2 = {}, o2["icon__button"] = true, o2[r] = true, o2["".concat(r, "--disabled")] = this.disabled, o2["size-".concat(this.size)] = true, o2), "data-test": this.dataTest, tabindex: "0" }, h("bds-icon", { name: this.icon, size: n, theme: this.iconTheme, color: "inherit" }));
  };
  return o;
}();
IconButton.style = iconButtonCss;
export {
  IconButton as bds_button_icon
};
//# sourceMappingURL=bds-button-icon.entry-Bj-aUdaj.js.map
