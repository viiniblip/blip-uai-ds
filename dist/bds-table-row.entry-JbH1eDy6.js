...
var TableRow = function() {
  function t(t2) {
    ...
    this.selected = false;
    this.toggleCollapse = function(t3) {
      if (e.collapse) {
        var s = document.querySelector('[body-collapse="'.concat(t3, '"]'));
  ...
  t.prototype.componentWillLoad = function() {
    ...
    this.collapseRow = document.querySelector('[body-collapse="'.concat(this.dataTarget, '"]'));
  ...
  t.prototype.componentWillUpdate = function() {
    var t2 = this.element.closest("bds-table");
    if (t2 && (t2.getAttribute("dense-table") === "true" || t2.denseTable === true)) {
      this.isDense = true;
    }
  };
  t.prototype.render = function() {
    ...
    if (this.bodyCollapse) {
      ...
      var s = this.element.closest("bds-table-header") === this.element.parentElement;
      return h(Host, { class: (t2 = { host: true }, t2["clickable--".concat(this.clickable)] = !s && this.clickable === true ? true : false, t2["selected--".concat(this.selected)] = true, t2["dense-row"] = this.isDense, t2), onClick: function() {
        return e.toggleCollapse(e.dataTarget);
      } }, this.collapse && h("bds-table-cell", { type: "custom" }, !s && h("bds-icon", { class: { arrow: true, active: this.isCollapsed }, name: "arrow-down" })), h("slot", null));
    }
  };
...
export {
  TableRow as bds_table_row
};
//# sourceMappingURL=bds-table-row.entry-JbH1eDy6.js.map
